...
import com.collegefest.studentmanagementspring.dao.UserDetailsServiceImpl;
	 ...
	 @Bean
	    ...
	    protected void configure(HttpSecurity http) throws Exception {
	        http.authorizeRequests()
	            .antMatchers("/","/students/save","/books/showFormForAdd","/students/403").hasAnyAuthority("USER","ADMIN")
